...
@description('Optional. The name of the subnet to create for the spoke front door. If set, it overrides the name generated by the template.')
param spokeFrontDoorSubnetName string = 'snet-fd'

@description('CIDR of the spoke Application Gateway subnet. If the value is empty, this subnet will not be created.')
param spokeFrontDoorSubnetAddressPrefix string
...
// Append optional application gateway subnet, if required
var fdAndDefaultSubnets = !empty(spokeFrontDoorSubnetAddressPrefix) ? concat(appGwAndDefaultSubnets, [
    {
      name: spokeFrontDoorSubnetName
      properties: {
        addressPrefix: spokeFrontDoorSubnetAddressPrefix
        privateLinkServiceNetworkPolicies: 'Disabled'
        // networkSecurityGroup: {
        //   id: nsgFD.outputs.nsgId
        // }
      }
    }
...
var spokeSubnets = vmJumpboxOSType != 'none' ? concat(fdAndDefaultSubnets, [
    {
      name: vmSubnetName
      properties: {
